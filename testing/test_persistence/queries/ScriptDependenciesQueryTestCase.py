...
class ScriptDependenciesQueryTestCase(unittest.TestCase):
    ...
    def setUpClass(cls) -> None:
        # PARAMETER
        cls.web_site = 'www.youtube.it/feed/explore'
        print(f"PARAMETER = {cls.web_site}")

    def test_1_get_scripts_from_web_site(self):
        print(f"\n------- [1] START GETTING SCRIPTS FORM WEB SITE QUERY -------")
        try:
        ...
        print(f"------- [1] END GETTING SCRIPTS FORM WEB SITE QUERY -------")

    def test_2_get_script_sites_from_web_site(self):
        print(f"\n------- [2] START GETTING SCRIPT SITES FORM WEB SITE QUERY -------")
        try:
        ...
        print(f"------- [2] END GETTING SCRIPT SITES FORM WEB SITE QUERY -------")

    def test_3_get_script_sites_from_web_site(self):
        print(f"\n------- [3] START GETTING SCRIPT SERVERS FORM WEB SITE QUERY -------")
        try:
        ...
        print(f"------- [3] END GETTING SCRIPT SERVERS FORM WEB SITE QUERY -------")
