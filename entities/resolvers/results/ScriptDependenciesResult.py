...
class ScriptDependenciesResult:
    ...
    Attributes
    ----------
    https : Set[MainPageScript] or None
    ...
    """
    def __init__(self, https_script_set: Set[MainPageScript] or None, http_script_set: Set[MainPageScript] or None):
        """
        Initialize object.

        :param https_script_set: All the script that the web site depends upon using HTTPS scheme.
        :type https_script_set: Set[MainPageScript] or None
