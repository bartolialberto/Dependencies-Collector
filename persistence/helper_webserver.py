...
from persistence import helper_url, helper_website, helper_website_lands
...
def get_first_from_string_website_and_https_flag(website: str, https: bool) -> WebServerEntity:
    try:
        wla = helper_website_lands.get_first_from_string_website_and_https_flag(website, https)
    except DoesNotExist:
        raise
    return WebServerEntity.get_by_id(wla.webserver)
