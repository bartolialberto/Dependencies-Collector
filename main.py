...
def get_input_application_flags(default_complete_unresolved_database=False, default_consider_tld=True, default_execute_rov_scraping=True) -> Tuple[bool, bool, bool]:
    """
